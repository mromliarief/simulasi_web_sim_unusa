...
<body>
	<table border="0" cellpadding="1" cellspacing="1" align="center" width="1000px" class="table1">
		...
		<h1 align="center">Form Pendaftaran Seminar Mahasiswa</h1>
		...
		<!--Content-->
			...
			<table border="0" align="center" cellspacing="9" cellpadding="5" width="380px" bgcolor="white">
				<tr>
					<td colspan="2" align="center"><b>Isikan Data Diri Anda</b></td>
				</tr>
				
			<form method="post" action="proses_pendaftaran.php">
					<tr>
						<td>NIM</td>
						<td><input type="text" name="nim" placeholder="masukkan NIM" required="nim"></td>
						</tr>
					<tr>
						<td>Nama Lengkap</td>
						<td><input type="text" name="nama_lengkap" placeholder="masukkan nama lengkap" required="nama_lengkap"></td>
					</tr>
					<tr>
						<td>Jenis Kelamin</td>
						<td><input type="text" name="jenis_kelamin" placeholder="masukkan L/P" required="jenis_kelamin"></td>
					</tr>
					<tr>
						<td>Agama</td>
						<td><input type="text" name="agama" placeholder="masukkan agama" required="agama"></td>
					</tr>
					<tr>
						<td>Prodi</td>
						<td><input type="text" name="prodi" placeholder="masukkan prodi" required="prodi"></td>
					</tr>
					<tr>
						<td>Nama Dosen Wali</td>
					   	<td><select name="dosen_wali" required="dosen_wali">
